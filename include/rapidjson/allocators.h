...
public:
    static const bool kNeedFree
        = false; //!< Tell users that no need to call Free() with this
                 //!< allocator. (concept Allocator)

    //! Constructor with chunkSize.
    /*! \param chunkSize The size of memory chunk. The default is
       kDefaultChunkSize. \param baseAllocator The allocator for allocating
       memory chunks.
    */
    ...
    /*! The user buffer will be used firstly. When it is full, memory pool
       ...
       sizeof(ChunkHeader). \param chunkSize The size of memory chunk. The
       default is kDefaultChunkSize. \param baseAllocator The allocator for
...
private:
    ...
    MemoryPoolAllocator& operator=(
        const MemoryPoolAllocator& rhs) /* = delete */;
    ...
    */
    ...
    BaseAllocator*
        ownBaseAllocator_; //!< base allocator created by this object.
};
