...
/*! \ingroup RAPIDJSON_CONFIG
   ...
   bytes alignment on 32-bit platforms and 8 bytes alignment for 64-bit
   platforms. User can customize by defining the RAPIDJSON_ALIGN function macro.
*/
    ...
    (p = reinterpret_cast<type*>(                                              \
         (reinterpret_cast<uintptr_t>(p)                                       \
             & static_cast<uintptr_t>(                                         \
                 RAPIDJSON_UINT64_C2(0xFFFF0000, 0x00000000)))                 \
...
#define RAPIDJSON_GETPOINTER(type, p)                                          \
    (reinterpret_cast<type*>(reinterpret_cast<uintptr_t>(p)                    \
        & static_cast<uintptr_t>(                                              \
            RAPIDJSON_UINT64_C2(0x0000FFFF, 0xFFFFFFFF))))
#else
