#ifndef MARNAV_IO_DEVICE_HPP
#define MARNAV_IO_DEVICE_HPP
...
namespace io {
    ...
    public:
        ...
        /// Reads data from the opened device into the buffer of the specified
        /// size.
        ///
        /// @param[out] buffer The buffer to contain all read data.
        /// @param[in] size The size of the buffer.
        /// @return The number of bytes read into the buffer.
        /// @exception std::invalid_argument Parameter errors (buffer is
        /// nullptr, size is zero, ...)
        /// @exception std::runtime_error Probably a read error. This does not
        /// include EOF.
